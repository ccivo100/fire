...
CREATE TABLE `com_apartment_type` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='部门-故障';

#
# Data for table "com_apartment_type"
#

INSERT INTO `com_apartment_type` VALUES (27,1,1,'1','2015-06-09 17:54:42',NULL,NULL),(28,9,9,'2','2015-06-09 17:57:06',NULL,NULL),(29,9,14,'2','2015-06-09 17:57:06',NULL,NULL);
...
CREATE TABLE `com_order` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='工单';

#
# Data for table "com_order"
#

INSERT INTO `com_order` VALUES (42,'故障提交-标题',7,'2015-06-03 11:29:08','故障提交-内容',1,1,NULL,2,NULL,0,NULL,NULL);
...
CREATE TABLE `com_position` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='职位';

#
# Data for table "com_position"
#

INSERT INTO `com_position` VALUES (1,'研发总监',NULL,'2015-04-18 11:08:15','2015-04-20 12:08:30',NULL),(2,'技术总监',NULL,'2015-04-18 11:21:51',NULL,NULL),(3,'产品总监',NULL,'2015-04-18 11:22:07',NULL,NULL),(4,'技术员',NULL,'2015-04-18 11:08:29','2015-04-18 11:21:08',NULL),(5,'工程师',NULL,'2015-04-18 11:08:45','2015-04-20 12:08:37',NULL),(6,'测试员',NULL,'2015-04-20 12:19:51',NULL,NULL),(7,'研发总监',NULL,'2015-05-22 12:40:26',NULL,NULL),(8,'研发总监',NULL,'2015-05-22 12:41:08',NULL,NULL),(9,'AAA',NULL,'2015-06-08 12:17:34',NULL,'2015-06-08 12:17:36');
...
CREATE TABLE `com_user_order` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='运维-工单';

#
# Data for table "com_user_order"
#

INSERT INTO `com_user_order` VALUES (88,4,42,'2015-06-03 11:29:08',NULL,NULL),(89,7,42,'2015-06-03 11:29:08',NULL,NULL);
...
INSERT INTO `sec_user_info` VALUES (1,1,0,0,1,9,1,'2015-03-11 10:42:24','2015-04-30 14:47:39',NULL),(2,4,1,0,1,5,5,'2015-03-13 15:35:03','2015-04-30 14:47:50',NULL),(3,3,1,0,1,9,4,'2015-03-16 12:18:29','2015-04-29 11:06:31',NULL),(4,2,1,0,1,4,2,'2015-03-16 17:18:17','2015-04-29 11:06:31',NULL),(7,7,3,0,1,5,5,'2015-05-07 17:32:02',NULL,NULL),(9,9,1,0,1,9,1,'2015-05-18 16:04:11',NULL,NULL),(10,10,1,0,4,4,5,'2015-05-18 16:11:25',NULL,NULL),(11,11,1,0,5,4,5,'2015-05-18 16:14:06',NULL,NULL),(12,12,1,0,1,12,5,'2015-05-18 16:14:47',NULL,NULL),(13,13,1,0,1,12,5,'2015-05-18 16:15:30',NULL,NULL),(62,62,1,1,1,9,1,'2015-05-22 20:00:31',NULL,NULL),(63,63,1,0,1,9,5,'2015-06-02 18:58:41',NULL,NULL),(64,64,1,0,2,12,2,'2015-06-04 14:22:22',NULL,NULL);
...
CREATE TABLE `sec_user_role` (
  ...
  `role_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='用户-角色';

#
# Data for table "sec_user_role"
#

INSERT INTO `sec_user_role` VALUES (1,1,1),(34,8,4),(35,9,2),(37,10,3),(38,11,3),(39,12,4),(41,13,4),(43,2,3),(44,17,4),(48,18,4),(54,20,2),(56,21,4),(57,22,3),(59,4,3),(60,4,4),(61,7,4),(63,3,4),(64,63,2);
